...
// в архитектурном паттерне MVC (Model-View-Controller) распределение модулей хромает: View и Controller очень неразрывно связаны друг с другом и роли между ними не разделены, тестируемость затруднительна, но код получился самым коротким
